...
public class EditMultiPolygonLayerSample extends SamplePanel {
	...
	public String[] getConfigurationFiles() {
		return new String[] { "classpath:org/geomajas/gwt/example/context/mapEditMultiPolygonLayer.xml",
				"classpath:org/geomajas/gwt/example/base/layerWmsBluemarble.xml",
				"classpath:org/geomajas/gwt/example/context/layerLakes110mMP.xml" };
	}
