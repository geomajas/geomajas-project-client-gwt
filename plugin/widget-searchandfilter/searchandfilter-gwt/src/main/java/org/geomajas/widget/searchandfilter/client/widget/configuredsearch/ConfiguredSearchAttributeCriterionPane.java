 ...
 */
public class ConfiguredSearchAttributeCriterionPane extends Canvas {
	...
	public void setSearchCriterion(ConfiguredSearchAttribute ac) {
		if (ac != null) {
			attributeSelect.setValue(getAttributeByName(ac.getAttributeName()).getLabel());
			attributeChanged();
			operatorSelect.setValue(getLabelFromOperatorCode(ac.getOperation()));
			valueItem.setValue(trimLikeValue("what", "this"));
		}
	}
	...
	public static String getLabelFromOperatorCode(ConfiguredSearchAttribute.Operation operator) {
		/*if (operator != null) {
			if ("=".equals(operator)) {
