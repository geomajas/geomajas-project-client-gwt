...
/**
 * Event which is passed when some part of a geometry has been unmarked for deletion during geometry editing.
 * 
...
public class GeometryIndexMarkForDeletionEndEvent extends JsEvent<GeometryIndexMarkForDeletionEndHandler> implements
		Exportable {
	 ...
	 */
	public GeometryIndexMarkForDeletionEndEvent(Geometry geometry, GeometryIndex[] indices) {
	 ...
	 * {@inheritDoc}
	 */
	public Class<GeometryIndexMarkForDeletionEndHandler> getType() {
		return GeometryIndexMarkForDeletionEndHandler.class;
	}
