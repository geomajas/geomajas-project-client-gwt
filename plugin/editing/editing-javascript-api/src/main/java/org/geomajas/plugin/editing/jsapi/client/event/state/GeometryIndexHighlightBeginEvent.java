...
public class GeometryIndexHighlightBeginEvent extends JsEvent<GeometryIndexHighlightBeginHandler> implements 
		Exportable {
	...
	protected void dispatch(GeometryIndexHighlightBeginHandler handler) {
		handler.onGeometryIndexHighlightBegin(this);
	}
