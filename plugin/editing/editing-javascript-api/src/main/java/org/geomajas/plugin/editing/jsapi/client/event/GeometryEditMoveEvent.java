...
/**
 * Event which is passed when some part of a geometry has been translated during geometry editing.
 * 
...
public class GeometryEditMoveEvent extends JsEvent<GeometryEditMoveHandler> implements Exportable {
