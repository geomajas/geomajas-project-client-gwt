...
public class GeometryIndexDisabledEvent extends JsEvent<GeometryIndexDisabledHandler> implements Exportable {
	 ...
	 */
	public GeometryIndexDisabledEvent(Geometry geometry, GeometryIndex[] indices) {
	 ...
	 * {@inheritDoc}
	 */
	public Class<GeometryIndexDisabledHandler> getType() {
		return GeometryIndexDisabledHandler.class;
	}

	protected void dispatch(GeometryIndexDisabledHandler handler) {
		handler.onGeometryIndexDisabled(this);
	}
