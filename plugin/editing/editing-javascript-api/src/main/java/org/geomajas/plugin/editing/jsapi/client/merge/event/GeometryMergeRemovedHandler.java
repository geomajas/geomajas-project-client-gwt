...
@Api(allMethods = true)
@UserImplemented
public interface GeometryMergeRemovedHandler extends JsHandler, Exportable {

	/**
	 * Executed when a geometry has been removed from the list for merging.
	 * 
	 * @param event
	 *            The geometry merging removed event.
	 */
	void onGeometryMergeRemoved(GeometryMergeRemovedEvent event);
}