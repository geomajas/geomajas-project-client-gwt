 ...
 * 
 */
public class InfoDragLineHandlerShowingWindow extends BaseDragLineHandler implements GeometryEditStartHandler,
	 ...
	 */
	public InfoDragLineHandlerShowingWindow(MapWidget map, GeometryEditService editService) {
		super(editService);
		this.map = map;
	}
	...
	/**
	 * Default implementation of {@link org.geomajas.plugin.editing.gwt.client.gfx.InfoProvider}.
	 * 
	 * @author Jan De Moerloose
	 * 
	 */
