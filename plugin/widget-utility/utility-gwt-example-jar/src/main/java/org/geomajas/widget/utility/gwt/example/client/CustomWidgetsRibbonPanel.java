 ...
 */
public class CustomWidgetsRibbonPanel extends SamplePanel {

	public static final String TITLE = "GuwCustomWidgetsRibbon";
	...
	public static final SamplePanelFactory FACTORY = new SamplePanelFactory() {
		...
		public SamplePanel createPanel() {
			return new CustomWidgetsRibbonPanel();
		}
	};
	...
	public String getDescription() {
		return MESSAGES.customWidgetsRibbonDescription();
	}
