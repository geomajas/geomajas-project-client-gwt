 ...
 */
public class VendorSpecificPanel extends SamplePanel {
	...
	public static final SamplePanelFactory FACTORY = new SamplePanelFactory() {
		...
		public SamplePanel createPanel() {
			return new VendorSpecificPanel();
		}
	};
	...
	public String[] getConfigurationFiles() {
		return new String[] { 
				"classpath:org/geomajas/plugin/vendorspecific/gwt/example/context/appGeoTools.xml",
				"classpath:org/geomajas/plugin/vendorspecific/gwt/example/context/mapGeoTools.xml",
				"classpath:org/geomajas/plugin/vendorspecific/gwt/example/context/layerCountriesGeoTools.xml",
				"classpath:org/geomajas/plugin/vendorspecific/gwt/example/context/layerCountriesGeoToolsPostGis.xml",
				"classpath:org/geomajas/plugin/vendorspecific/gwt/example/context/clientLayerCountriesGeoTools.xml",
				"classpath:org/geomajas/plugin/vendorspecific/gwt/example/context/spring-geotools.xml"};
	}
